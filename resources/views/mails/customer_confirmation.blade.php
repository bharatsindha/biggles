            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="container590" width="590">
                ...
                <tr>
                    <td align="center">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="container590" width="590">
                            <tr>
                                <td align="center" height="70" style="height:70px;"><a href="" style="display: block; border-style: none !important; border: 0 !important;"><img alt="" border="0" src="{{ asset('assets/media/logo.svg') }}" style="display: block; width: 100px;" width="100" /></a></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="container590" width="590">
                            <tr>
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    <p style="line-height: 24px; margin-bottom:15px;">Hi {{ $name }},</p>
                                    <p style="line-height: 24px;margin-bottom:15px;"> Welcome to Biggles! </p>
                                    <p style="line-height: 24px;margin-bottom:15px;"> You account has been created, please click on the below link to verify the account. </p>
                                    <p>Verification link: <a href="{{ $encryptedLink }}">{{ $encryptedLink }}</a></p>
                                    <br /><br />
