                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-1">
                                    <label class="form-label" for="start_addr">
                            ...
                            <div class="col-md-6">
                                <div class="mb-1">
                                    ...
                                    {!!  Form::text('start_date', old('start_date'),[
                                        'id' => 'start_date',
                                        'class' => 'form-control flatpickr-basic flatpickr-input'. (($errors->has('start_date')) ? 'is-invalid' : ''),
                            ...
                            <div class="col-md-6">
                                ...
                                {{ trans('move::move.pickup_window_start') }}:
                                    ...
                                    {!!  Form::text('pickup_window_start', old('pickup_window_start'),[
                                        ...
                                        'class' => 'form-control '. (($errors->has('pickup_window_start')) ? 'is-invalid' : ''),
                            ...
                            <div class="col-md-6">
                                <div class="mb-1">
                                    ...
                                    {!!  Form::text('pickup_window_end', old('pickup_window_end'),[
                                        ...
                                        'class' => 'form-control number-format'. (($errors->has('pickup_window_end')) ? 'is-invalid' : ''),
                        ...
                        <div class="row">
                           ...
                           {{ trans('move::move.delivery_window_start') }}:
                                    ...
                                    {!!  Form::text('delivery_window_start', old('delivery_window_start'),[
                                        ...
                                        'class' => 'form-control '. (($errors->has('delivery_window_start')) ? 'is-invalid' : ''),
                           ...
                           {{ trans('move::move.delivery_window_end') }}:
                                    ...
                                    {!!  Form::text('delivery_window_end', old('delivery_window_end'),[
                                        ...
                                        'class' => 'form-control '. (($errors->has('delivery_window_end')) ? 'is-invalid' : ''),
                                        'placeholder' => 'Please enter Delivery Window Start Date',
                                        'required' => 'required', 
                                        'onchange'=>'javascript:formatPrice(this);'
                                        ]) !!}
...
@section('scripts')
    ...
    {{-- <link href="{{asset('css/pickers/flatpickr/flatpickr.min.css')}}" rel="stylesheet"/> --}}
