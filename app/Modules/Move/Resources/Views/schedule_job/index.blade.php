...
@section('content')
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        <!-- begin:: Content -->
        <div
            class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid pending__job_calendar fc-view-harness fc-view-harness-active">
            <div class="row">
                            ...
                            <!-- begin:: Content Head -->
                                <div class="kt-subheader  kt-grid__item __hide__onboarding" id="kt_subheader">
                                    <div class="onboard_contnet">
                                        ...
                                        <img class="close_icon __close__onboarding"
                                             src="{{ asset('assets/media/close.svg') }}" alt="">
                                    </div>
                                </div>
                                <!-- end:: Content Head -->
                            @endif
