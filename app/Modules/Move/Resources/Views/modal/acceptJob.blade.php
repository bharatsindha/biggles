    ...
    <div class="modal-dialog" role="document" style="max-width: 800px;">
        <div class="modal-content">
            <div class="modal-header flex-wrap">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <p>Please specify an estimated date / time window for pickup and delivery. This helps us to know
                    when to
                    schedule the final payment from the customer so you get paid on time.</p>
                <p>
                    <b>
                        Requested date:
                        {{ !is_null($move->requested_date) && !empty($move->requested_date) ?
                        Carbon\Carbon::parse($move->requested_date)->format('d M Y - H:i') : '' }}
                    </b>
                </p>
                @endif
            ...
            <div class="modal-body">
                <div class="form-group row mb-1">
                    <div class="col-lg-6">
                        <label class="form-label" for="pickup_window_start">Pickup Start Date</label>
                        {!! Form::text('pickup_window_start', old('pickup_window_start'), [
                        'id' => 'pickup_window_start',
                        'class' => 'form-control flatpickr-basic flatpickr-date-time flatpickr-input',
                        'autocomplete' => 'off',
                        'required' => 'required',
                        ]) !!}
                    ...
                    <div class="col-lg-6">
                        <label class="form-label" for="pickup_window_end">Pickup End Date</label>
                ...
                <div class="form-group row ">
                    <div class="col-lg-6">
                        <label class="form-label" for="delivery_window_start">Delivery Start Date</label>
                        {!! Form::text('delivery_window_start', old('delivery_window_start'), [
                        'id' =>'delivery_window_start',
                        'class' => 'form-control commonDatepicker flatpickr-basic flatpickr-date-time',
                        'autocomplete' => 'off',
                        'required' => 'required'
                        ]) !!}
                    ...
                    <div class="col-lg-6">
                        <label class="form-label" for="delivery_window_end">Delivery End Date</label>
            ...
            <div class="modal-footer">
                ...
                <input type="submit" class="btn btn-primary font-weight-bold"
                    value="{{ $updateStatus == 1 ? 'Update job' : 'Accept job and set dates' }}">
            </div>
        </div>
    </div>
</div>
