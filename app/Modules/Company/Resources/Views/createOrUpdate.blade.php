            ...
            <div class="row">
                <div class="col-lg-8">
                        ...
                        @endif
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <label class="form-label">{{ trans('company::company.company_name') }}:</label>
                                        {!!  Form::text('name', old('name'),[
                                            'id' => 'name',
                                            'class' => 'form-control '. (($errors->has('name')) ? 'is-invalid' : ''), 'placeholder' => 'Please enter Name','required' => 'required']) !!}
                                        @if($errors->has('name'))
                    ...
                    <div class="kt-portlet container_space">
                        <div class="card">
                            <div class="card-header pb-50">
                                <h4 class="card-title">Interstate Settings</h4>
                            </div>
                        <div class="card-body">
                            <div class="border-bottom mb-1"></div>
                            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <div class="mb-1">
                                    <label class="form-label">{{ trans('company::company.extra_kms') }}:</label>
                                    {!!  Form::number('extra_kms', isset($company->interState->extra_kms) ? $company->interState->extra_kms : old('extra_kms'),['id' => 'extra_kms','class' => 'form-control '. (($errors->has('extra_kms')) ? 'is-invalid' : ''),'placeholder' => 'Please enter extra kms','required' => 'required', 'step'=>"any"]) !!}
                                ...
                                <div class="col-md-3">
                                    <div class="mb-1">
                                    <label class="form-label">{{ trans('company::company.packaging') }}:</label>
                                    {!!  Form::number('packing', isset($company->interState->packing) ? $company->interState->packing : old('packing'),['id' => 'packing','class' => 'form-control '. (($errors->has('packaging')) ? 'is-invalid' : ''),'placeholder' => 'Please enter packing','required' => 'required', 'step'=>"any"]) !!}
                                ...
                                <div class="col-md-3">
                                    <div class="mb-1">
                                    <label class="form-label">{{ trans('company::company.storage') }}:</label>
                                    {!!  Form::number('storage', isset($company->interState->storage) ? $company->interState->storage : old('storage'),['id' => 'storage','class' => 'form-control '. (($errors->has('storage')) ? 'is-invalid' : ''),'placeholder' => 'Please enter storage','required' => 'required', 'step'=>"any"]) !!}
